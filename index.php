...
<body>
	...
	<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			...
			<!-- Second slide -->
			<div class="item">
				<img src="slide2_cursos.png" alt="Segundo slide">

				<div class="carousel-caption align-left">
					<img data-animation="animated bounceInLeft" src="USA.png" alt="Bandeira dos Estados Unidos da América" class="first-flag-img-in-languages-carousel course-img"  >
					<span data-animation="animated bounceInLeft" class="lang-text">Inglês</span>
					<br>
					<img data-animation="animated bounceInLeft" src="Germany.png" alt="Bandeira da Alemanha"   class="course-img">
					<span data-animation="animated bounceInLeft" class="lang-text">Alemão</span>
					<br>
					<img data-animation="animated bounceInLeft" src="Spain.png" alt="Bandeira da Espanha"   class="course-img">
					<span data-animation="animated bounceInLeft" class="lang-text">Espanhol</span>
					<br>
					<img data-animation="animated bounceInLeft" src="China.png" alt="Bandeira da China"   class="course-img">
					<span data-animation="animated bounceInLeft" class="lang-text">Mandarim</span>
					<br>
					<img data-animation="animated bounceInLeft" src="Japan.png" alt="Bandeira do Japão"   class="course-img">
			...
			<!-- Third slide -->
			<div class="item">
				<img src="slide3_contato.png" alt="Terceiro slide">
				...
				<div class="carousel-caption align-left">
					...
					<div class="flex-wrap">
						...
						<img data-animation="animated bounceInLeft" src="whatsapp-icon.png" alt="Bandeira do Japão" class="whatsapp-icon-img">
					</div>
				</div>
			</div>
		</div>
		...
		<div>
			...
			<div class="quem-somos-content-box">
				<div class="quem-somos-img-box">
					<img src="cultivar_logo.png" class="img-circle quem-somos-img" alt="Logo da cultivar idiomas">
				</div>
		...
		<div>
			...
			<div class="flex-wrap">
				<ul style="margin-left: auto;">
					<li>
						<img src="USA.png" alt="Bandeira dos Estados Unidos da América"   class="course-img">
						<span>Inglês</span>
					</li>
					<li>
						<img src="Germany.png" alt="Bandeira da Alemanha"   class="course-img">
						<span>Alemão</span>
					</li>
					<li>
						<img src="Spain.png" alt="Bandeira da Espanha"   class="course-img">
						<span>Espanhol</span>
					</li>
					<li>
						<img src="Italy.png" alt="Bandeira da Itália"   class="course-img">
						<span>Italiano</span>
					</li>
				</ul>
				<ul style="margin-right: auto;">
					<li>
						<img src="Japan.png" alt="Bandeira do Japão"   class="course-img">
						<span>Japonês</span>
					</li>
					<li>
						<img src="France.png" alt="Bandeira da França"   class="course-img">
						<span>Francês</span>
					</li>
					<li>
						<img src="China.png" alt="Bandeira da China"   class="course-img">
						<span>Mandarim</span>
					</li>
					<li>
						<img src="Brazil.png" alt="Bandeira do Brasil"   class="course-img">
						<span>Português</span>
					</li>
				</ul>
			</div>
			...
			<blockquote class="first-blockquote">
				<div class="blockquote-content-box">
					<div class="blockquote-img-box">
						<img src="dina_aquino.jpg" class="img-circle blockquote-img" alt="Foto do aluno do depoimento">
					</div>
